        ...
        <Row justify="center">
          <Col className="contact-left" span={12}>
            ...
            <div style={{ padding: "0rem 2rem" }}>
              <Row>
                  <Col>
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-envelope-fill contact-icons" viewBox="0 0 16 16">
              ...
              <Row>
                  <Col>
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-telephone-outbound-fill contact-icons" viewBox="0 0 16 16">
